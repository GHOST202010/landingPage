...
<body id="page-top">
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold"> Jake Smith </h1>
                    <hr class="divider" />
                </div>
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5"> Bienvenido a mi página</p>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white mt-0">Carrera</h2>
                    <hr class="divider divider-light" />
                    <p class="text-white-75 mb-4"> En proceso de capacitación para aprender técnicas sobre la seguridad informática lo cual es algo que me apasiona. Actualmete soy Developer jr. </p>
                    <a class="btn btn-light btn-xl" href="#services">¿Quién soy?</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="page-section" id="services">
        <div class="container px-4 px-lg-5">
            <h2 class="text-center mt-0">Sobre mí</h2>
            <hr class="divider" />
            <div class="row gx-4 gx-lg-5">
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <div class="mb-2"><i class="bi-gem fs-1 text-primary"></i></div>
                        <h3 class="h4 mb-2">Programar</h3>
                        <p class="text-muted mb-0">Me gusta mucho la programación, en general disfruto el programar, aunque claro creo que todos los que programamos entendemos que cuando nos trabamos en algo y no podemos resolverlo se empieza a volver muy tedioso.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <div class="mb-2"><i class="bi-laptop fs-1 text-primary"></i></div>
                        <h3 class="h4 mb-2">Informática</h3>
                        <p class="text-muted mb-0">En general tengo conociemtos sobre el área de informática, como lo son conocimiento sobre redes, servidores, bases de datos entre otras cosas.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
    ...
    <footer class="bg-light py-5">
        <div class="container px-4 px-lg-5">
            <div class="small text-center text-muted">Copyright &copy; 2022 - GHOST202010 Corporation</div>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
